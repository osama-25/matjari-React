    ...
    return (
        <div className="m-2">
            ...
            <div class="relative mt-2 rounded-md shadow-sm">
                <input type="text" name={text} id={text} class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
        </div>
    );
}
